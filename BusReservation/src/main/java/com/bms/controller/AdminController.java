...
//	http://localhost:9090/admin/viewallorigins                                               [24]

	// TESTED IN SPRING BOOT
	@RequestMapping(value = "/viewallorigins", method = RequestMethod.GET)
	public List<String> viewAllOrigins() {
		return routeService.viewAllOrigins();
	}

//	http://localhost:9090/admin/viewalldestinations                                          [25]

	// TESTED IN SPRING BOOT
	@RequestMapping(value = "/viewalldestinations", method = RequestMethod.GET)
	public List<String> viewAllDestinations() {
		return routeService.viewAllDestinations();
	}

//	http://localhost:9090/admin/viewallrouteid                                                [26]

	// TESTED IN SPRING BOOT
	@RequestMapping(value = "/viewallrouteid", method = RequestMethod.GET)
	public List<Integer> viewAllRouteId() {
		return routeService.viewAllRouteId();
	}
